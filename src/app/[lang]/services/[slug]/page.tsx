  ...
  "developpement-logiciel": {
    fr: {
      ...
      body: <SectionGrid sections={[
        ...
        { title: "Logiciels métier", items: ["FinAnalyzer — analyse financière", "ProcessMap — cartographie de processus", "Solutions conçues pour les besoins réels des entreprises"] },
      ]} />,
    ...
    en: {
      ...
      body: <SectionGrid sections={[
        ...
        { title: "Business software", items: ["FinAnalyzer — financial analysis", "ProcessMap — process mapping", "Solutions designed for real enterprise needs"] },
      ]} />,
