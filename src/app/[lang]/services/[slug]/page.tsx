  ...
  "developpement-logiciel": {
    fr: {
      ...
      body: <SectionGrid sections={[
        ...
        { title: "Logiciels métier", items: ["FinAnalyzer — analyse financière", "ProcessMap — cartographie de processus", "DataBridge — intégration et transformation de données", "Solutions conçues pour les besoins réels des entreprises"] },
      ]} />,
    ...
    en: {
      ...
      body: <SectionGrid sections={[
        ...
        { title: "Business software", items: ["FinAnalyzer — financial analysis", "ProcessMap — process mapping", "DataBridge — data integration and transformation", "Solutions designed for real enterprise needs"] },
      ]} />,
